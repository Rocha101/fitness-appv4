import { CheckmarkCircle02Icon, Cancel01Icon, AlertCircleIcon } from "@hugeicons/core-free-icons";
        ...
        <Modal transparent visible={visible} animationType="none">
            <View className="flex-1 justify-start items-center pt-16 px-4">
                <Animated.View
                    ...
                    className={`w-full max-w-sm rounded-xl border-2 p-4 shadow-lg ${styles.containerStyle}`}
                >
                    <View className="flex-row items-start">
                        ...
                        <View className="flex-1">
                            <Text className={`text-lg font-semibold mb-1 ${styles.titleColor}`}>
                                {title}
                            </Text>
                            <Text className={`text-base ${styles.messageColor}`}>
                                {message}
                            </Text>
                        </View>
